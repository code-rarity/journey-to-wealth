<?php
/**
 * Provides the view for the API Settings page.
 *
...
<div class="wrap">
    ...
    <p><?php esc_html_e( 'Configure the API settings for fetching stock data.', 'journey-to-wealth' ); ?></p>
    ...
    <form method="post" action="options.php">
         ...
         *
         * The parameter 'journey-to-wealth_api_settings_group' should match
         * the first argument in the register_setting() function call in Journey_To_Wealth_Admin::register_settings()
         * for the API key setting.
         */
        settings_fields( 'journey-to-wealth_api_settings_group' );

        /**
         * WordPress function that prints out all settings sections added to a particular settings page.
         *
         * The parameter 'journey-to-wealth_api_settings_page_identifier' should match
         * the page slug passed to add_settings_section() and add_settings_field()
         * in Journey_To_Wealth_Admin::register_settings() for the API settings.
         */
        do_settings_sections( 'journey-to-wealth_api_settings_page_identifier' );
